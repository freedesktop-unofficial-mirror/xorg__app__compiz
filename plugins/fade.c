		 ...
		 CompDisplay *d)
{
    ...
    d->data.base.privates[displayPrivateIndex].ptr = fd;
		...
		CompScreen *s)
{
    ...
    s->data.base.privates[fd->screenPrivateIndex].ptr = fs;
		...
		CompWindow *w)
{
    ...
    w->data.base.privates[fs->windowPrivateIndex].ptr = fw;
