		  ...
		  CompDisplay *d)
{
    ...
    d->data.base.privates[displayPrivateIndex].ptr = vd;
		 ...
		 CompScreen *s)
{
    ...
    s->data.base.privates[vd->screenPrivateIndex].ptr = vs;
		 ...
		 CompWindow *w)
{
    ...
    w->data.base.privates[vs->windowPrivateIndex].ptr = vw;
