	      ...
	      CompCore   *c)
{
    ...
    c->data.base.privates[corePrivateIndex].ptr = bc;
		 ...
		 CompDisplay *d)
{
    ...
    d->data.base.privates[displayPrivateIndex].ptr = bd;
		...
		CompScreen *s)
{
    ...
    s->data.base.privates[bd->screenPrivateIndex].ptr = bs;
		...
		CompWindow *w)
{
    ...
    w->data.base.privates[bs->windowPrivateIndex].ptr = bw;

    if (w->u.base.u.base.parent)
	blurWindowAdd (w->screen, w, w->u.base.u.base.name);
