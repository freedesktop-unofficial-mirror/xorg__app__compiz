...
static CompBool
outputInitObject (const CompObjectFactory *factory,
		  CompObject	          *object)
{
    return cObjectInit (factory, object, getObjectType (), &outputObjectVTable);
}

static void
outputFiniObject (const CompObjectFactory *factory,
		  CompObject	          *object)
{
